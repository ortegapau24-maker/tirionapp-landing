...
export const metadata = { title: 'Changelog — TirionApp' };
...
export default function ChangelogPage() {
    return (
        <div className="min-h-screen flex flex-col items-center justify-center px-6 py-32 bg-agency-bg-dark">
            ...
            <h1 className="text-[clamp(2.5rem,5vw,4.5rem)] font-outfit font-semibold text-agency-text-main leading-[1.1] tracking-tight text-center mb-6">Changelog</h1>
            <p className="text-[1.15rem] text-agency-text-muted max-w-[520px] text-center leading-[1.7] font-light mb-10">
                Stay up to date with the latest improvements, feature releases, and architectural updates to the TirionApp platform.
            </p>
            <p className="text-agency-text-muted/40 text-sm mb-10">No entries yet. Check back soon.</p>
