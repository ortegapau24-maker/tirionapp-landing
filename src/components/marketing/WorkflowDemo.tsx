...
export function WorkflowDemo({ step }: WorkflowDemoProps) {
    ...
    const nodes: NodeDef[] = [
        ...
        { id: '3', x: 18, y: 50, show: showZendesk, label: 'Zendesk', color: '#EF4444', radius: 38 },
        { id: '4', x: 10, y: 72, show: showSlack, label: 'Slack', color: '#10B981', radius: 36 },
        ...
        { id: '5', x: 82, y: 50, show: showPostgres, label: 'PostgreSQL', color: '#10B981', radius: 38 },
        { id: '6', x: 72, y: 72, show: showTwilio, label: 'Twilio', color: '#F22F46', radius: 36 },
        { id: '5b', x: 90, y: 72, show: showPostgres, label: 'HubSpot', color: '#FF7A59', radius: 36 },
    ];
